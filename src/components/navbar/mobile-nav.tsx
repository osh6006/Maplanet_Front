...
const MobileNav: React.FunctionComponent<IMobileNavProps> = ({ userInfo, accessToken }) => {
  ...
  return (
    <div className='absolute left-0 z-20 flex w-full items-center justify-between px-3 sm:hidden'>
      ...
      {isOpen ? (
        <div ref={ref} className='fixed inset-y-0 left-0 w-1/2 bg-background px-4'>

      ...
      {isClient ? (
        createPortal(
          <div
            ...
            onClick={onClose}>
            <div
              className='relative mx-10 max-h-[500px] min-w-[360px] max-w-2xl overflow-x-hidden overflow-y-scroll rounded-md bg-tableBackground px-10 py-16 sm:max-h-full sm:overflow-hidden sm:px-12'
              onClick={(e) => {
                e.stopPropagation();
              }}>

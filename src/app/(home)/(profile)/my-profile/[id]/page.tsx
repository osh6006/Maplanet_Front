...
const MyProfile: React.FunctionComponent<IMyProfileProps> = () => {
  ...
  const renderPosts = () => {
    if (currentBoard === 'board1') {
      return <ProfileBoard1Posts type='my' board={currentBoard} userId={userId} page={page} />;
    } else if (currentBoard === 'board2') {
      return <ProfileBoard2Posts type='my' board={currentBoard} userId={userId} page={page} />;
    } else if (currentBoard === 'board3') {
      return <ProfileBoard3Posts type='my' board={currentBoard} userId={userId} page={page} />;
    } else if (currentBoard === 'board4') {
      return <ProfileBoard4Posts type='my' board={currentBoard} userId={userId} page={page} />;
    }
  };
  ...
  return (
    <div className='w-full'>
      {/* 프로필 배너 */}
      <ProfileBanner type='my' board={currentBoard} userId={userId} page={page} />

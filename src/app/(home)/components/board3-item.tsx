...
const Board3Item: React.FunctionComponent<IBoard3ItemProps> = ({
  board3_id,
  user_id,
  discord_id,
  meso,
        ...
        <div className='flex flex-wrap gap-[5px]'>
          ...
          <Badge size='card' className='bg-lightGray text-[12px]'>
            <div className='flex items-center gap-1'>
              ...
              <span className='pb-[1px]  text-[12px]'>{hunting_ground}</span>
            </div>
          </Badge>
          <Badge size='card' className='bg-lightGray text-[12px]'>
            <div className='flex items-center gap-1'>
          ...
          <Badge size='card' className='bg-lightGray text-[12px]'>
            <div className='flex items-center gap-1 '>
              <span className='text-[12px] font-semibold text-stone-300 '>LV</span>
